...
ARTIFACTS_STRUCTURE = {
    ...
    'technical': {
        'name': 'Техническая документация - Обязательные элементы',
        'items': [
            ...
            'Параметры подключения к источникам данных (с указанием версии источника данных, если это критично)',
            'Версии ПО',
    ...
    'bi': {
        ...
        'items': [
            ...
            'Правила/стандарты визуализации (если есть у компании)',
            'Пользовательская документация (инструкции администраторов и бизнес-пользователей)',
            'История изменений отчетов (при наличии)',
    ...
    'rpa': {
        ...
        'items': [
            'Сценарии автоматизации (bot-процессы) (описание общее, схема, описания скриптов)',
            'Пути к исполняемым файлам',
            'Настройки планировщика задач',
            'Логи работы роботов - пути',
            'Описание контрольных точек (итоги выполнения скрипта, которые можно мониторить)',
